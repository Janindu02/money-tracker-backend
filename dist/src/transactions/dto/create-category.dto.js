...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Pet Care' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Heart' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: client_1.TransactionType, default: client_1.TransactionType.EXPENSE }),
    (0, class_validator_1.IsOptional)(),
